...
export const getEmployment = asyncHandler(async (req, res) => {
    const userId = req.user.id;
...
export const getTargetUniversities = asyncHandler(async (req, res) => {
    const userId = req.user.id;
...
export const addTargetUniversity = asyncHandler(async (req, res) => {
    const userId = req.user.id;
...
export const deleteTargetUniversity = asyncHandler(async (req, res) => {
    const userId = req.user.id;
