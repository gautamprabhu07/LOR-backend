...
import { SubmissionStatus } from "../../core/utils/statusTransitions.js";
...
export const emailService = {
   ...
   */
  send: async (type: EmailType, to: string, context: EmailContext): Promise<void> => {
    try {
 ...
 */
const validateEmailContext = (type: EmailType, context: EmailContext): void => {
  switch (type) {
 ...
 */
const renderTemplate = (type: EmailType, context: EmailContext): {
  subject: string;
  html: string;
} => {
